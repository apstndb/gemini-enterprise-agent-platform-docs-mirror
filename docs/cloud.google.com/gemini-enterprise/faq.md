---
name: documents/cloud.google.com/gemini-enterprise/faq
uri: https://cloud.google.com/gemini-enterprise/faq
title: Gemini Enterprise app frequently asked questions
description: Find answers to common questions about Gemini Enterprise app. Learn what it is, who it's for, editions, agents, connectors, security, and compliance.
data_source: cloud.google.com
---

# Gemini Enterprise app frequently asked questions

### Getting started

#### What is Gemini Enterprise app?

Gemini Enterprise app is an advanced agentic platform that brings the best of Google AI to every employee, for every workflow. It empowers teams to discover, create, share, and run AI agents—all in one secure environment.

#### What does Gemini Enterprise app do?

With Gemini Enterprise app, every individual in any organization can shift from tedious tasks to high-impact work, thereby enhancing team productivity, fostering creativity, and improving business outcomes.

With Gemini Enterprise app, your employees can access Google’s powerful AI models through an intuitive chat interface, deploy ready-to-use agents made by Google and our thriving ecosystem of partners, and even create their own custom agents with a powerful no-code workbench, all while maintaining your security, privacy and governance over all the agents.

#### Who should use Gemini Enterprise app?

Gemini Enterprise app is designed to benefit all teams across diverse business sectors and organizations. It empowers knowledge workers in departments like sales, marketing, finance, HR, and IT/engineering, as well as frontline staff such as warehouse managers and retail associates, to gain insights faster and automate routine tasks.

#### What are the differences between Gemini Enterprise app editions?

Gemini Enterprise app has several editions designed to fit the unique needs of your organization.

**Business edition**: Great for individuals, small businesses, and teams up to 300—no IT setup needed.

**Standard and Plus editions**: Designed for organizations that need stricter security and compliance requirements. Includes higher quota, unlimited seats, access to third-party agents, and Gemini Code Assist.

**Frontline edition**: Catered to frontline workers. (Standard and Plus edition customers have the option to purchase the Frontline edition as an add-on). 

If you are a government or educational institution, we provide tailored offerings like Gemini for Government to address your specific needs. Contact your Google Cloud sales representative to learn more.

#### Is Gemini Enterprise Agent Platform included with Gemini Enterprise app?
...
Gemini Enteprise Agent Platform provides the foundational capabilities to build, scale, govern, and optimize agents across all of Gemini Enterprise. The developer-built agents from Agent Platform come to life across tailored delivery surfaces which include the Gemini Enterprise app, Gemini Enterprise for Customer Experience, and custom surfaces built by you or your partners.
...
While both the Gemini app and Gemini Enterprise app benefit from Google's cutting-edge AI models and enterprise-grade security and compliance controls, Gemini Enterprise app might be especially beneficial for teams that need to synthesize data from a broad set of company data sources (beyond Google Workspace), leverage Google-made, custom, and 3rd-party agents, and meet HIPAA compliance and data residency requirements for NotebookLM.

#### How do I access Gemini Enterprise app?
...
#### How does Gemini Enterprise compare to other AI tools like ChatGPT Business and ChatGPT Enterprise?

Gemini Enterprise is Google Cloud's advanced agentic platform, designed from the ground up based on our deep expertise in developing secure, enterprise-grade solutions. It gives you access to the industry-leading Gemini models, combined with Google-quality search connected across your company’s data to get full context, letting your teams easily search, analyze, and summarize information, and automate entire processes with quality and ease. 

Gemini Enterprise also comes with a ready-to-deploy "taskforce" of specialized agents for complex workflows, like Deep Research and NotebookLM, providing immediate value out-of-the-box. This, combined with a powerful no-code workbench that allows any employee to build and share their own custom agents, provides a complete solution that empowers organizations to accelerate tasks and fundamentally transform how work gets done—with a foundation of security and governance you can trust.

### Agents and connectors

#### What prebuilt agents are available in Gemini Enterprise app?
...
*\*Available only in the Standard and Plus editions on Gemini Enterprise app.*

For more information about agents, click [here](https://cloud.google.com/gemini-enterprise/agents).

#### Can I bring my own agents to Gemini Enterprise app?
...
[See all available connectors in Standard and Plus editions](https://docs.cloud.google.com/gemini/enterprise/docs/connect-third-party-data-source)

### Security and compliance

#### Who owns the data and does Google use my data for training models?
...
#### What identity and access controls does Gemini Enterprise app offer?

The Standard and Plus editions of Gemini Enterprise app support various identity providers to authenticate users and enforce data access controls from connected enterprise systems. It verifies both user access to the application and access to data from connectors to ensure that content within Gemini Enterprise app is accessible only to authorized individuals. 
