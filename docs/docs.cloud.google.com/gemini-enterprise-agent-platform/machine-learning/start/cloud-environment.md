...
> **Note:** If you're an administrator setting up a project for a team, see [Set up a project for a team](https://docs.cloud.google.com/vertex-ai/docs/general/set-up-project) .
...
## What's next
  ...
  - Read an [overview of Agent Platform](https://docs.cloud.google.com/vertex-ai/docs/start/introduction-unified-platform) .
