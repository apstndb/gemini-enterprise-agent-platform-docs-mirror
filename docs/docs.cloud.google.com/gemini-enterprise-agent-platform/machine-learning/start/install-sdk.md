...
2.  [Install the Agent Platform SDK package](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/start/install-sdk#install-python-sdk)
3.  [Initialize the Agent Platform SDK](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/start/install-sdk#initialize-python-sdk)
