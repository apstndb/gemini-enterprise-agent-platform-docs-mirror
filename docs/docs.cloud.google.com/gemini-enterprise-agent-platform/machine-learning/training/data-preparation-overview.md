...
### Specific to Ray on Agent Platform
  ...
  - Ray can directly read data from Cloud Storage. For example, when running [Spark on Ray](https://docs.cloud.google.com/vertex-ai/docs/open-source/ray/run-spark-on-ray) , you can read files from Cloud Storage.
