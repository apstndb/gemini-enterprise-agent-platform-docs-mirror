...
When you [create a serverless training pipeline](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/training/create-training-pipeline) , you can specify that your training application uses a Agent Platform dataset.
