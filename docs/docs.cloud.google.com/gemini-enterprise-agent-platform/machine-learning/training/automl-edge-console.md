...
5.  In the **Train new model** page, complete the following steps:
    ...
    3.  If you want manually set how your training data is split, expand **Advanced options** and select a data split option. [Learn more](https://docs.cloud.google.com/vertex-ai/docs/general/ml-use) .
    
    4.  Click **Continue** .
    
    5.  ***Classification** models only (optional)* : In the **Explainability** section, select check\_box **Generate explainable bitmaps for each image in the test set** to enable [Vertex Explainable AI](https://docs.cloud.google.com/vertex-ai/docs/explainable-ai/overview) . Choose [visualization settings](https://docs.cloud.google.com/vertex-ai/docs/explainable-ai/visualization-settings-automl-icn) and click **Continue** .
        
        This feature has costs associated with it. See [Pricing](https://docs.cloud.google.com/gemini-enterprise-agent-platform/pricing) for more information.
...
## What's next
  ...
  - [Evaluate AutoML models](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/training/evaluating-automl-models) .
  - [Export AutoML Edge models](https://docs.cloud.google.com/vertex-ai/docs/export/export-edge-model) .
  - [Use Vertex Explainable AI to understand model behavior](https://docs.cloud.google.com/vertex-ai/docs/explainable-ai/overview) .
