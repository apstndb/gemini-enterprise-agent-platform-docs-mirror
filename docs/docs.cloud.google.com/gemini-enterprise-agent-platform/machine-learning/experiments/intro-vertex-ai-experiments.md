...
Agent Platform Experiments lets you use a schema to define the type of artifact. For example, supported schema types include `system.Dataset` , `system.Model` , and `system.Artifact` . For more information, see [System schemas](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/ml-metadata/system-schemas) .
