...
The [Feature availability](https://docs.cloud.google.com/vertex-ai/docs/general/locations#americas_1) table lists the available locations for Vertex AI Experiments. When using Gemini Enterprise Agent Platform Pipelines or Vertex AI TensorBoard, they must be in the same location as your Agent Platform experiment.
