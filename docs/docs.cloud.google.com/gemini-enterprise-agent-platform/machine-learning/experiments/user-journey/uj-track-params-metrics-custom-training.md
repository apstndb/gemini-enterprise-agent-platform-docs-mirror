...
This notebook demonstrates how to use Google Cloud SDK for Python to track metrics and parameters for Vertex AI custom training jobs, and how to perform detailed analysis using this data.
...
## Relevant content
  ...
  - [Vertex ML Metadata](https://docs.cloud.google.com/vertex-ai/machine-learning/ml-metadata/introduction)
  - [Custom training overview](https://docs.cloud.google.com/vertex-ai/machine-learning/training/overview)
  - [Endpoint](https://docs.cloud.google.com/vertex-ai/docs/python-sdk/prediction-classes#endpoint)
  - [Create and manage experiment runs](https://docs.cloud.google.com/vertex-ai/docs/experiments/create-manage-exp-run#vertex-ai-sdk-for-python)
