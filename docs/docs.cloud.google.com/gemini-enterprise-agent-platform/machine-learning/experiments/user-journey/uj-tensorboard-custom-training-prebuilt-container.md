---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/experiments/user-journey/uj-tensorboard-custom-training-prebuilt-container
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/experiments/user-journey/uj-tensorboard-custom-training-prebuilt-container
title: 'Vertex AI TensorBoard custom training with prebuilt container: Notebook'
...
> To see an example of tensorboard custom training with prebuilt container, run the "Vertex AI TensorBoard custom training with prebuilt container" notebook in one of the following environments:
> 
