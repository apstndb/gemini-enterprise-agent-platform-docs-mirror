...
The optimized TensorFlow runtime is backward compatible with [prebuilt TensorFlow Serving containers](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/predictions/pre-built-containers#tensorflow "prebuilt TensorFlow Serving containers") . If you're running TensorFlow models with a prebuilt container, you can switch to an optimized TensorFlow runtime container with minimal effort.
