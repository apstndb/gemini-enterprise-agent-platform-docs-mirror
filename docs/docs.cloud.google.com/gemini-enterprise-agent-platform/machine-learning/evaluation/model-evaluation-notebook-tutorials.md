---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/evaluation/model-evaluation-notebook-tutorials
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/evaluation/model-evaluation-notebook-tutorials
title: Agent Platform model evaluation notebook tutorials
description: Browse notebook tutorials to help you get started using model evaluation in Vertex AI.
data_source: docs.cloud.google.com
---

This document contains a list of available Vertex AI model evaluation notebook tutorials. These end-to-end tutorials help you get started using Vertex AI model evaluation and can give you ideas for how to implement a specific project.
...
To open a notebook tutorial in Colab, click the **Colab** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/evaluation/model-evaluation-notebook-tutorials#notebook-list) . Colab creates a VM instance with all needed dependencies, launches the Colab environment, and loads the notebook.
...
2.  Click the **Colab Enterprise** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/evaluation/model-evaluation-notebook-tutorials#notebook-list) . Colab Enterprise loads the notebook.
...
2.  Click the **Vertex AI Workbench** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/evaluation/model-evaluation-notebook-tutorials#notebook-list) .
...
1.  Click the **GitHub** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/evaluation/model-evaluation-notebook-tutorials#notebook-list) .
