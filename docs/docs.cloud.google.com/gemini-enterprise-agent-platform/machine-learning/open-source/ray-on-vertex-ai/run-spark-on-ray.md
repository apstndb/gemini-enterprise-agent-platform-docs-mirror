---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/open-source/ray-on-vertex-ai/run-spark-on-ray
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/open-source/ray-on-vertex-ai/run-spark-on-ray
...
> To see an example of getting started with Spark on Ray on , run the "Spark on Ray on " notebook in one of the following environments:
> 
...
To interactively connect to the Ray cluster on Gemini Enterprise Agent Platform, see [Connect to a Ray cluster through Ray Client](https://docs.cloud.google.com/vertex-ai/docs/open-source/ray-on-vertex-ai/develop-application#sdk)
