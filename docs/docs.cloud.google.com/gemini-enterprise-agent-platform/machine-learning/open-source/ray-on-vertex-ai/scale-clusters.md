---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/open-source/ray-on-vertex-ai/scale-clusters
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/open-source/ray-on-vertex-ai/scale-clusters
...
> **Note:** Manual scaling has a limitation due to VPC peering. Google recommends using a [Private Service Connect interface](https://docs.cloud.google.com/vertex-ai/docs/open-source/ray-on-vertex-ai/create-cluster#use-psc-i-egress) when you implement a private VPC network.
...
As an alternative, we recommend deploying Ray on Agent Platform with a [Private Service Connect Interface](https://docs.cloud.google.com/vertex-ai/docs/open-source/ray-on-vertex-ai/create-cluster#use-psc-i-egress) , which reduces IP consumption to a /28 subnet.
