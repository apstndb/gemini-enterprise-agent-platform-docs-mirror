...
## What's next
  ...
  - [Deploy a model on Gemini Enterprise Agent Platform and get predictions](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/open-source/ray/deploy-predict)
