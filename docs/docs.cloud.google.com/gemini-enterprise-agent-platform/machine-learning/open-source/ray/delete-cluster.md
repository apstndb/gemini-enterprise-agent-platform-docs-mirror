...
When you finish [developing an application](https://docs.cloud.google.com/vertex-ai/docs/open-source/ray/develop-application) for your Ray cluster on Gemini Enterprise Agent Platform, delete the cluster to avoid unnecessary billing.
