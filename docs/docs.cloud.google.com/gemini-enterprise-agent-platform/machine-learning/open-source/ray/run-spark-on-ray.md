...
To interactively connect to the Ray cluster on Gemini Enterprise Agent Platform, see [Connect to a Ray cluster through Ray Client](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/open-source/ray/develop-application#sdk)
