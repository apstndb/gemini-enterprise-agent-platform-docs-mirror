---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/ml-metadata/ml-metadata-notebook-tutorials
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/ml-metadata/ml-metadata-notebook-tutorials
title: Vertex ML Metadata notebook tutorials
description: Lists tutorial notebooks relevant to Vertex ML Metadata.
...
To open a notebook tutorial in Colab, click the **Colab** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/ml-metadata/ml-metadata-notebook-tutorials#notebook-list) . Colab creates a VM instance with all needed dependencies, launches the Colab environment, and loads the notebook.
...
2.  Click the **Colab Enterprise** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/ml-metadata/ml-metadata-notebook-tutorials#notebook-list) . Colab Enterprise loads the notebook.
...
2.  Click the **Vertex AI Workbench** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/ml-metadata/ml-metadata-notebook-tutorials#notebook-list) .
...
1.  Click the **GitHub** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/ml-metadata/ml-metadata-notebook-tutorials#notebook-list) .
