...
You can train models in BigQuery in three ways:
  ...
  - [Ray on BigQuery](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/open-source/ray-on-vertex-ai/overview) : Use Ray to scale AI and Python applications like machine learning.
