---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tutorials/custom-training-pipelines/custom-training-jupyter-notebooks
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tutorials/custom-training-pipelines/custom-training-jupyter-notebooks
title: Custom training notebook tutorials
description: Find a notebook tutorial to help you get started using Agent Platform custom training.
...
2.  Click the **Colab Enterprise** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tutorials/custom-training-pipelines/custom-training-jupyter-notebooks#notebook-list) . Colab Enterprise loads the notebook.
...
2.  Click the **Vertex AI Workbench** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tutorials/custom-training-pipelines/custom-training-jupyter-notebooks#notebook-list) .
...
1.  Click the **GitHub** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tutorials/custom-training-pipelines/custom-training-jupyter-notebooks#notebook-list) .
