...
6.  In the **Train new model** page, complete the following steps:
    ...
    3.  Select your target column.
        ...
        Learn more about [target column requirements](https://docs.cloud.google.com/vertex-ai/docs/tabular-data/classification-regression/prepare-data#data-structure) .
    ...
    5.  **Optional** : To choose how to split the data between training, test, and validation sets, open the **Advanced options** . You can choose between the following data split options:
        ...
        Learn more about [data splits](https://docs.cloud.google.com/vertex-ai/docs/tabular-data/data-splits) .
    ...
    9.  Review the transformations selected for your included features, along with whether invalid data is allowed, and make any required updates.
        ...
        Learn more about [transformations](https://docs.cloud.google.com/vertex-ai/docs/datasets/data-types-tabular#transformations) and [invalid data](https://docs.cloud.google.com/vertex-ai/docs/datasets/data-types-tabular#null-values) .
    ...
    10. If you want to specify a weight column, or change your optimization objective from the default, open the **Advanced options** and make your selections.
        ...
        Learn more about [weight columns](https://docs.cloud.google.com/vertex-ai/docs/tabular-data/classification-regression/prepare-data#weight) and [optimization objectives](https://docs.cloud.google.com/vertex-ai/docs/tabular-data/classification-regression/train-model#optimization-objectives) .
...
The methods you use to split your data depend on your data type:
  ...
  - `FractionSplit` :
    ...
    If you specify any of the fractions, specify all. The fractions must add up to 1.0. [Learn more](https://docs.cloud.google.com/vertex-ai/docs/tabular-data/data-splits) .
  ...
  - `PredefinedSplit` :
    ...
    Manually specify the data split for each row by using a split column. [Learn more](https://docs.cloud.google.com/vertex-ai/docs/tabular-data/data-splits) .
