...
Before you can view the hyperparameter logs for your model, you must [train it](https://docs.cloud.google.com/vertex-ai/docs/tabular-data/classification-regression/train-model) .
