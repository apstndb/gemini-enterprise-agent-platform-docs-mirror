...
description: Learn about the workflow for creating a forecast model and making predictions in Vertex AI.
...
| 3\. [Train a forecast model](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/forecasting/train-model)                             | Train a forecast model in Vertex AI using your dataset.                 |
