...
description: Create a forecast using a trained forecast model in Vertex AI.
...
Vertex AI sends the output of batch inferences to the destination that you specified. This destination can be either BigQuery or Cloud Storage.
