---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/forecasting/get-predictions
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/forecasting/get-predictions
title: Get inferences for a forecast model
description: Create a forecast using a trained forecast model in Gemini Enterprise Agent Platform.
data_source: docs.cloud.google.com
---

This page shows how to create a forecast using your trained forecast model.
...
Gemini Enterprise Agent Platform sends the output of batch inferences to the destination that you specified. This destination can be either BigQuery or Cloud Storage.
