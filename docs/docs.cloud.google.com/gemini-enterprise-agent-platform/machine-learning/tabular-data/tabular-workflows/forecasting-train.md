...
If you receive a quota error while running Tabular Workflow for Forecasting, you might need to request a higher quota. To learn more, see [Manage quotas for Tabular Workflows](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/tabular-workflows/quotas) .
...
| `time_column`                      | String        | The time column. To learn more, see [Data structure requirements](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/forecasting/prepare-data#data-structure) .                                                                                                                                                                                                                                                                                                                                                       |
| `time_series_identifier_columns`   | List\[str\]   | The time series identifier columns. To learn more, see [Data structure requirements](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/forecasting/prepare-data#data-structure) .                                                                                                                                                                                                                                                                                                                                    |
| `weight_column`                    | String        | (Optional) The weight column. To learn more, see [Add weights to your training data](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/forecasting/prepare-data#weight) .                                                                                                                                                                                                                                                                                                                                            |
