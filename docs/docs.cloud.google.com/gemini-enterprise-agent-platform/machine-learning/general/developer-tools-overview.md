...
Gemini Enterprise Agent Platform includes the following tools to help data scientists and software engineers develop machine learning (ML) workflows:
  ...
  - Vertex AI Workbench is a Jupyter notebook-based development environment that data scientists can use for their entire ML workflow. For more information, see [Introduction to Vertex AI Workbench](https://docs.cloud.google.com/vertex-ai/docs/workbench/introduction) .
...
## What's next
  ...
  - Learn about [Vertex AI Workbench](https://docs.cloud.google.com/vertex-ai/docs/workbench/introduction) .
