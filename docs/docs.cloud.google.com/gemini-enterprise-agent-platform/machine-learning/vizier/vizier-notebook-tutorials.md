---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/vizier/vizier-notebook-tutorials
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/vizier/vizier-notebook-tutorials
title: Agent Platform Vizier notebook tutorials
description: Provides a list of Vertex AI Vizier notebook tutorials to guide users in getting started with the service and inspire project implementations.
data_source: docs.cloud.google.com
---

This document contains a list of available Vertex AI Vizier notebook tutorials. These end-to-end tutorials help you get started using Vertex AI Vizier and can give you ideas for how to implement a specific project.
...
To open a notebook tutorial in Colab, click the **Colab** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/vizier/vizier-notebook-tutorials#notebook-list) . Colab creates a VM instance with all needed dependencies, launches the Colab environment, and loads the notebook.
...
2.  Click the **Colab Enterprise** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/vizier/vizier-notebook-tutorials#notebook-list) . Colab Enterprise loads the notebook.
...
2.  Click the **Vertex AI Workbench** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/vizier/vizier-notebook-tutorials#notebook-list) .
...
1.  Click the **GitHub** link in the [notebook list](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/vizier/vizier-notebook-tutorials#notebook-list) .
