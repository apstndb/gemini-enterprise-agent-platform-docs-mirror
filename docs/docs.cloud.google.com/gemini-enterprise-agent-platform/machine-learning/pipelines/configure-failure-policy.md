...
Replace the following:
  ...
  - LOCATION : The region that the pipeline runs in. For more information about the regions that Gemini Enterprise Agent Platform Pipelines is available in, see the [Gemini Enterprise Agent Platform locations guide](https://docs.cloud.google.com/vertex-ai/docs/general/locations#feature-availability) . If you don't set this parameter, the default location set in `aiplatform.init` is used.
