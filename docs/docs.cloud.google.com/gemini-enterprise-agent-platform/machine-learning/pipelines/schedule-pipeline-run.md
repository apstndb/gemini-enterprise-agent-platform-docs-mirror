...
Before using any of the request data, make the following replacements:
  ...
  - LOCATION : The region where you want to run the pipeline. For more information about the regions where Gemini Enterprise Agent Platform Pipelines is available, see the [Gemini Enterprise Agent Platform locations guide](https://docs.cloud.google.com/vertex-ai/docs/general/locations#feature-availability) .
...
Before using any of the request data, make the following replacements:
  ...
  - LOCATION : The region where the pipeline run schedule is currently active. For more information about the regions where Gemini Enterprise Agent Platform Pipelines is available, see the [Gemini Enterprise Agent Platform locations guide](https://docs.cloud.google.com/vertex-ai/docs/general/locations#feature-availability) .
...
Before using any of the request data, make the following replacements:
  ...
  - LOCATION : The region where the pipeline run schedule is currently paused. For more information about the regions where Gemini Enterprise Agent Platform Pipelines is available, see the [Gemini Enterprise Agent Platform locations guide](https://docs.cloud.google.com/vertex-ai/docs/general/locations#feature-availability) .
...
Before using any of the request data, make the following replacements:
  ...
  - LOCATION : The region where you want to delete the pipeline schedule. For more information about the regions where Gemini Enterprise Agent Platform Pipelines is available, see the [Gemini Enterprise Agent Platform locations guide](https://docs.cloud.google.com/vertex-ai/docs/general/locations#feature-availability) .
