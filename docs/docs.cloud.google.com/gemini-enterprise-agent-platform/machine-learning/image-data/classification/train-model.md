...
Before using any of the request data, make the following replacements:
  ...
  - MODELTYPE <sup>†</sup> : The type of Cloud-hosted model to train. The options are:
      - `CLOUD` (default)
  - NODE\_HOUR\_BUDGET <sup>†</sup> : The actual training cost will be equal or less than this value. For Cloud models the budget must be: 8,000 - 800,000 milli node hours (inclusive). The default value is 192,000 which represents one day in wall time, assuming 8 nodes are used.
