---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/function-calling
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/function-calling
title: Function calling reference
description: Reference documentation for function calling in Gemini Enterprise Agent Platform, including supported models, syntax, parameters, and examples.
...
For more conceptual documentation on function calling, see [Introduction to function calling](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/tools/function-calling) .
...
See [examples](https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/function-calling#examples) for implementation details.
