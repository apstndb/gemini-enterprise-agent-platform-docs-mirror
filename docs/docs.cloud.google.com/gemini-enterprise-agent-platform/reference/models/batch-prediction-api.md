---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/batch-prediction-api
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/batch-prediction-api
...
For more information about the batch workflow and how to format your input data, see [Batch inference with Gemini](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-gemini) .
...
See [examples](https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/batch-prediction-api#examples) for implementation details.
...
The prompt input format. Use `jsonl` for Cloud Storage or `bigquery` for BigQuery.

`gcsSource.uris`

The input source URI. This is a Cloud Storage location of the JSONL file in the form `gs://bucketname/path/to/file.jsonl` .

`bigquerySource.inputUri`

The input source URI. This is a BigQuery table URI in the form `bq://project_id.dataset.table` . The region of the input BigQuery dataset must be the same as the Agent Platform batch prediction job.
...
The output format of the prediction. Use `bigquery` .

`gcsDestination.outputUriPrefix`

The Cloud Storage bucket and directory location, in the form `gs://mybucket/path/to/output` .

`bigqueryDestination.outputUri`

The BigQuery URI of the target output table, in the form `bq://project_id.dataset.table` . If the table doesn't already exist, then it is created for you. The region of the output BigQuery dataset must be the same as the Agent Platform batch prediction job.
...
Batch requests for multimodal models accept Cloud Storage storage and BigQuery storage sources. To learn more, see the following:
  ...
  - [Cloud Storage input format details](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-from-cloud-storage#prepare)
  - [BigQuery input format details](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-from-bigquery#prepare)
...
## What's next
  ...
  - Learn how to tune a Gemini model in [Overview of model tuning for Gemini](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/tune-models) .
  - Learn more about how to [Batch inference with Gemini](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-gemini) .
