...
Updates a Colab Enterprise runtime template. Use this tool to modify an existing runtime template's configuration. Format: 'projects/{project\_id}/locations/{region}/notebookRuntimeTemplates/{notebook\_runtime\_template\_id}'. CRITICAL: For {region}, use the region specified in the current context. If no region is specified, prompt the user for one. Do not use 'global'.
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;notebookRuntimeTemplate&quot;: {object (NotebookRuntimeTemplate)},&quot;updateMask&quot;: string}</code></pre></td>
</tr>
</tbody>
</table>
