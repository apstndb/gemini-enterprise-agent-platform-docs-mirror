---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/notebook_execution_list_jobs
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/notebook_execution_list_jobs
title: 'MCP Tools Reference: aiplatform.googleapis.com'
description: Gemini Enterprise Agent Platform is a central console designed for platform and security administrators to build, scale, monitor, optimize, and govern the entire lifecycle of AI agents.
data_source: docs.cloud.google.com
---

## Tool: `notebook_execution_list_jobs`

Lists your Colab Enterprise notebook execution jobs. Use this tool to view the status of past and current notebook runs. Format: 'projects/{project\_id}/locations/{region}'. CRITICAL: For {region}, use the region specified in the current context. If no region is specified, prompt the user for one. Do not use 'global'. IMPORTANT: If the returned list is empty, it means no execution jobs currently exist in this location; this is NOT a system failure. In this case, you should inform the user and ask if they would like to create a new execution job using the notebook\_execution\_create\_job tool.

The following sample demonstrate how to use `curl` to invoke the `notebook_execution_list_jobs` MCP tool.
...
--data &#39;{
  &quot;method&quot;: &quot;tools/call&quot;,
  &quot;params&quot;: {
    &quot;name&quot;: &quot;notebook_execution_list_jobs&quot;,
    &quot;arguments&quot;: {
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;parent&quot;: string,&quot;filter&quot;: string,&quot;pageSize&quot;: integer,&quot;pageToken&quot;: string,&quot;orderBy&quot;: string,&quot;view&quot;: enum (NotebookExecutionJobView)}</code></pre></td>
</tr>
</tbody>
</table>
