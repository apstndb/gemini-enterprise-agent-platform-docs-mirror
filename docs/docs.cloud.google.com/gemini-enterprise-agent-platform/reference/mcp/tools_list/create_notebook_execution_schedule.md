---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/create_notebook_execution_schedule
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/create_notebook_execution_schedule
...
Use this tool to create a notebook execution schedule to periodically launch scheduled runs of a notebook execution job. Format: 'projects/{project\_id}/locations/{region}'. CRITICAL: For {region}, use the region specified in the current context. If no region is specified, prompt the user for one. Do not use 'global'.
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;parent&quot;: string,&quot;schedule&quot;: {object (Schedule)}}</code></pre></td>
</tr>
</tbody>
</table>
