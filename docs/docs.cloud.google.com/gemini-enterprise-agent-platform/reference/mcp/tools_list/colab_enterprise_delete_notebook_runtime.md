---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/colab_enterprise_delete_notebook_runtime
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/colab_enterprise_delete_notebook_runtime
...
Deletes a Colab Enterprise runtime. Use this tool to permanently remove a runtime and its resources. Format: 'projects/{project\_id}/locations/{region}/notebookRuntimes/{notebook\_runtime\_id}'. CRITICAL: For {region}, use the region specified in the current context. If no region is specified, prompt the user for one. Do not use 'global'.
