---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/upload_model
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/upload_model
...
Registers a Model artifact into the Agent Platform Model Registry. Use this to create a new Model resource or upload a new version of an existing Model. This is a long-running operation. Format: 'projects/{project\_id}/locations/{region}'. CRITICAL: For {region}, use the region specified in the current context window. If no region is specified, prompt the user to provide one. Do not use 'global'. Use 'parent\_model' when uploading a new version of an existing model.

The following sample demonstrate how to use `curl` to invoke the `upload_model` MCP tool.
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;parent&quot;: string,&quot;parentModel&quot;: string,&quot;modelId&quot;: string,&quot;model&quot;: {object (Model)},&quot;serviceAccount&quot;: string}</code></pre></td>
</tr>
</tbody>
</table>
