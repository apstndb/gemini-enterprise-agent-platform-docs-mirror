---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/colab_enterprise_upgrade_notebook_runtime
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/mcp/tools_list/colab_enterprise_upgrade_notebook_runtime
...
Upgrades a Colab Enterprise runtime to a newer image/version. Format: 'projects/{project\_id}/locations/{region}/notebookRuntimes/{notebook\_runtime\_id}'. CRITICAL: For {region}, use the region specified in the current context. If no region is specified, prompt the user for one. Do not use 'global'.
