...
`inputs` ` object ( TftForecastingInputs  ` )

The input parameters of this TrainingJob.

`metadata` ` object ( TftForecastingMetadata  ` )
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;inputs&quot;: {object (TftForecastingInputs)},&quot;metadata&quot;: {object (TftForecastingMetadata)}}</code></pre></td>
</tr>
</tbody>
</table>
