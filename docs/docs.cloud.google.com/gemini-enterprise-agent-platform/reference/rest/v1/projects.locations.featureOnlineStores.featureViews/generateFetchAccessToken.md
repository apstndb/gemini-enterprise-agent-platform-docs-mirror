---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1/projects.locations.featureOnlineStores.featureViews/generateFetchAccessToken
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1/projects.locations.featureOnlineStores.featureViews/generateFetchAccessToken
...
post `https: / /{service-endpoint} /v1 /{featureView}:generateFetchAccessToken`  
