---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1/projects.locations/asyncRetrieveContexts
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1/projects.locations/asyncRetrieveContexts
...
post `https: / /{service-endpoint} /v1 /{parent}:asyncRetrieveContexts`  
