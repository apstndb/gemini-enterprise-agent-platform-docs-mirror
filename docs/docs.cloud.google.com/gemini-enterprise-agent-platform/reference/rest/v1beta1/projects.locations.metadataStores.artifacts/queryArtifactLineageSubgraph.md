---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.metadataStores.artifacts/queryArtifactLineageSubgraph
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.metadataStores.artifacts/queryArtifactLineageSubgraph
...
get `https: / /{service-endpoint} /v1beta1 /{artifact}:queryArtifactLineageSubgraph`  
