---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.models/deleteVersion
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.models/deleteVersion
...
delete `https: / /{service-endpoint} /v1beta1 /{name}:deleteVersion`  
