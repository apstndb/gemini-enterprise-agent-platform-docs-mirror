---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.schedules
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.schedules
...
`createModelMonitoringJobRequest` ` object ( CreateModelMonitoringJobRequest  ` )
...
`modelMonitoringJob` ` object ( ModelMonitoringJob  ` )
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;parent&quot;: string,&quot;modelMonitoringJob&quot;: {object (ModelMonitoringJob)},&quot;modelMonitoringJobId&quot;: string}</code></pre></td>
</tr>
</tbody>
</table>
