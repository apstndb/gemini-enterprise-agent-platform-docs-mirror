---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations/updateSemanticGovernancePolicyEngine
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations/updateSemanticGovernancePolicyEngine
...
patch `https: / /{service-endpoint} /v1beta1 /{semanticGovernancePolicyEngine.name}`  
