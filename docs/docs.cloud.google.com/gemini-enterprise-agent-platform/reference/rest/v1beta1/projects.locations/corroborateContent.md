---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations/corroborateContent
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations/corroborateContent
...
post `https: / /{service-endpoint} /v1beta1 /{parent}:corroborateContent`  
