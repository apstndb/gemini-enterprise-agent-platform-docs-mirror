---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.memoryBanks/ingestEvents
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/rest/v1beta1/projects.locations.memoryBanks/ingestEvents
title: 'Method: memoryBanks.ingestEvents'
...
post `https: / /{service-endpoint} /v1beta1 /{parent}:ingestEvents`  
