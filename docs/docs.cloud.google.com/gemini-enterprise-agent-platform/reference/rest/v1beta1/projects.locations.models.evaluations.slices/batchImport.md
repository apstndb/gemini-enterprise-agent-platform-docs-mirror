...
The schema of the prediction is stored in \[ModelEvaluation.annotation\_schema\_uri\]\[\]
...
The schema of the ground truth is stored in \[ModelEvaluation.annotation\_schema\_uri\]\[\]
