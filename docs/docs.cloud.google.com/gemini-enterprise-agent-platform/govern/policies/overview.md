...
description: Learn about policies to govern agent interactions in Agent Platform.
data_source: docs.cloud.google.com
---

> **Private Preview — Policies for Agent Gateway**
> 
> This feature is subject to the "Pre-GA Offerings Terms" in the General Service Terms section of the [Service Specific Terms](https://docs.cloud.google.com/terms/service-terms#1) . Pre-GA features are available "as is" and might have limited support. For more information, see the [launch stage descriptions](https://cloud.google.com/products/#product-launch-stages) .

You can define, apply, and manage policies that govern agent interactions in IAM.

By using the **Policies** page, you can do the following:

  - [Use Identity and Access Management (IAM) policies to govern agentic communication](https://docs.cloud.google.com/gemini-enterprise-agent-platform/govern/policies/overview#iam) .

  - [Use Semantic Governance Policies to govern traffic between agents and MCP servers and other tools](https://docs.cloud.google.com/gemini-enterprise-agent-platform/govern/policies/overview#sgp) .
...
To create an IAM policy for Agent Gateway, see [Create policy](https://docs.cloud.google.com/gemini-enterprise-agent-platform/govern/policies/assign-identity-iam) .
...
Policies have the following components:
  ...
  - **Agents** : In your IAM allow policies, source agents are defined by their agent identity. To learn how different types of agents receive identities, see [Agent identity](https://docs.cloud.google.com/gemini-enterprise-agent-platform/scale/runtime/agent-identity) . The agent identity of the agents that initiates communication with a service. Agent identities are represented by [principal identifiers](https://docs.cloud.google.com/iam/docs/principal-identifiers) that contain the SPIFFE-formatted identity of the agent. When you use the gcloud CLI to configure the IAM policy, the agent is the member that you grant access to.
...
To configure Semantic Governance Policies, see [Configure content and business policies](https://docs.cloud.google.com/gemini-enterprise-agent-platform/govern/policies/configure-semantic-governance) .
