...
| Maximum number of Agent Platform non-regional (global or multiregional) resources                           | 100   | `aiplatform.googleapis.com/non_regional_reasoning_engine_service_entities`       |
