...
For supported regional endpoints, see [data residency](https://docs.cloud.google.com/gemini-enterprise-agent-platform/resources/data-residency) .

Capability

Standard US and EU regions

Country-level regions (excluding US)
...
[Agent Platform RAG Engine](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/rag-engine/rag-overview)
