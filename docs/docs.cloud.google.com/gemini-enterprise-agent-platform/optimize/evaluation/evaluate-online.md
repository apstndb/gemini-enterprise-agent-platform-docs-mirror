---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/optimize/evaluation/evaluate-online
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/optimize/evaluation/evaluate-online
title: Continuous evaluation with online monitors
description: How to run continuous online agent evaluations in Gemini Enterprise Agent Platform.
...
Once you create a monitor, you can manage it from the **Online monitors** list:
  ...
  - **Status Toggle:** Click **More options** *more\_vert* and select **Enable** or **Disable** to pause evaluation without deleting the configuration.
  - **Pause and Resume:** Use **More options** *more\_vert* to temporarily stop evaluation.
...
3.  **Check Internal Logs:** Online Monitors write diagnostic information to **Cloud Logging** . If an evaluation fails, an error log is produced. You can find these logs in the **Logs Explorer** by searching for your monitor ID, or for specific traces and agents:
