...
| `429` , `RESOURCE_EXHAUSTED` , `at capacity`                                                                                             | [Region temporarily at capacity](https://docs.cloud.google.com/gemini-enterprise-agent-platform/troubleshooting/agent-deployment#region-capacity)                                       |
