...
If you have access to your Pinecone index name and the secret resource name with [your permissions set](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/rag-engine/use-pinecone#store-api-key-in-secret-manager) , then you can create your RAG corpus, and associate it with your Pinecone index, which is demonstrated in this sample code.
...
For an example on how to create the RAG corpus without providing the service account information, see [Create RAG corpus without an index name or an API key](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/rag-engine/use-pinecone#create-corpus-without-name-or-key) .
...
If this is your first RAG corpus and you don't have access to your service account details, or you haven't completed the [provisioning steps](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/rag-engine/use-pinecone#provision-service-account) for your Pinecone index, you can still create your RAG corpus. You can then associate the RAG corpus with an empty Pinecone configuration, and add the details later.
