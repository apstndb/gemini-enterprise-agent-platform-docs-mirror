...
You must make calls to these APIs from a client running in the same [VPC that the service was peered with](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/vector-search/vpc#vpc-network-peering-setup) .
