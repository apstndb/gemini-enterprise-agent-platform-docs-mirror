---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/resources/throughput-quota
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/resources/throughput-quota
title: Throughput quota
description: Learn how to manage throughput for your generative AI models in Gemini Enterprise Agent Platform, choosing between flexible pay-as-you-go or reserved capacity for consistent performance.
...
For the default pay-as-you-go model, Agent Platform uses [Standard pay-as-you-go (Standard PayGo)](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/standard-paygo) . PayGo lets you pay only for the resources that you consume, without requiring upfront financial commitments. There are additional PayGo options that vary in cost and performance. For more information, see [Priority PayGo](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/priority-paygo) or [Flex PayGo](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/flex-paygo) .

### Reserved Capacity

For critical production applications that require consistent performance and predictable costs, you can use [Provisioned Throughput](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/provisioned-throughput) . Provisioned Throughput is a fixed-cost subscription that reserves a specific amount of throughput for your models in a chosen location.
