---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/deploy/error-code-429
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/deploy/error-code-429
title: Error code 429
description: Understand 429 errors in Google Agent Platform. Manage Pay-as-you-go and Provisioned Throughput quotas to optimize request capacity.
...
To correct the 429 error generated by Provisioned Throughput, do the following:
  ...
  - Use the [Default behavior example](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/provisioned-throughput#default) , which doesn't set a header in prediction requests. Any overages are processed on-demand and billed as pay-as-you-go.
...
## What's next
  ...
  - To learn about quotas and limits for generative AI on Agent Platform, see [Quotas and system limits](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/quotas) .
