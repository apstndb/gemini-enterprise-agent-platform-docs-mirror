...
| -------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| Launch stage                                                                                                                                 | GA                                                                                              | GA                                                                                                  | GA                                                                                                            | Preview                                                                                         | GA                                                                                                            | GA                                                                                                  |
| Input modalities                                                                                                                             | Text , Image , Audio , Video                                                                    | Text , Image , Audio , Video                                                                        | Text , Image , Audio , Video                                                                                  | Text , Image , Audio , Video                                                                    | Text , Image , Audio , Video                                                                                  | Text , Image , Audio , Video                                                                        |
| Output modalities                                                                                                                            | Text                                                                                            | Text                                                                                                | Text                                                                                                          | Text                                                                                            | Text                                                                                                          | Text                                                                                                |
| Context window, total token limit                                                                                                            | 1,048,576                                                                                       | 1,048,576                                                                                           | 1,048,576                                                                                                     | 1,048,576                                                                                       | 1,048,576                                                                                                     | 1,048,576                                                                                           |
| Output context length                                                                                                                        | 65,535 (default)                                                                                | 65,535 (default)                                                                                    | 65,535 (default)                                                                                              | 65,536                                                                                          | 65,535 (default)                                                                                              | 65,535 (default)                                                                                    |
...
| Latency                                                                                                                                      |                                                                                                 |                                                                                                     |                                                                                                               |                                                                                                 |                                                                                                               |                                                                                                     |
| [Retirement date](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/model-versions)                                      | October 16, 2026                                                                                | October 16, 2026                                                                                    | October 16, 2026                                                                                              |                                                                                                 | May 7, 2027 or later                                                                                          | May 19, 2027 or later                                                                               |
...
> **Note:** Gemini 2 and later models are priced per token for inputs and outputs.
...
#### Fix breaking code changes
  ...
  - **Multimodal function responses** : For Gemini 3 Pro and later models, you can include image and PDF data in function responses. See [Multimodal function responses](https://docs.cloud.google.com/gemini-enterprise-agent-platform/multimodal/function-calling#mm-fr) .
