---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/video/insert-objects-into-videos
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/video/insert-objects-into-videos
title: Insert objects into Veo videos
description: Learn how to insert objects into Veo on Gemini Enterprise Agent Platform.
...
You can use Veo on Gemini Enterprise Agent Platform to insert objects into videos by providing a mask and an image object, then providing a prompt to the model that includes a description of the output that you want.
