---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/video/extend-a-veo-video
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/video/extend-a-veo-video
title: Use Veo to extend videos
description: You can extend your Veo on Gemini Enterprise Agent Platform-generated videos using either the {{dynamic_data.site_values.cloud_name_short}} console or Agent Platform API. Use this technique to create longer Veo videos.
data_source: docs.cloud.google.com
---

You can use Veo on Gemini Enterprise Agent Platform to extend videos to between 1 and 30 seconds in length. You can extend videos using either the Google Cloud console or the Agent Platform API.
...
For information about writing effective text prompts for video generation, see the [Veo prompt guide](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/video/video-gen-prompt-guide) .
