---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/open-models/vllm/use-vllm
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/open-models/vllm/use-vllm
title: vLLM serving for text-only and multimodal language models on Cloud GPUs
...
The vLLM implementation within Google Gemini Enterprise Agent Platform Model Garden is not a direct integration of the open-source library. Gemini Enterprise Agent Platform maintains a customized and optimized version of vLLM that is specifically tailored to enhance performance, reliability, and seamless integration within the Google Cloud.
...
These Gemini Enterprise Agent Platform-specific customizations, while often transparent to the end-user, enable you to maximize the performance and efficiency of your Llama 3.1 deployments on Gemini Enterprise Agent Platform Model Garden.
...
### 1\. Billing
  ...
  - **Enable Billing** : Make sure that billing is enabled for your project. You can refer to [Enable, disable, or change billing for a project](https://docs.cloud.google.com/billing/docs/how-to/modify-project) .
...
The Llama 3.1 and 3.2 collections each cater to different deployment scales and model sizes, providing you with flexible options for multilingual dialogue tasks and beyond. Refer to the [Llama overview page](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/partner-models/llama#meta-models) for more information.
...
Avoid sharing or exposing your token publicly or online. When you set your token as an environment variable during deployment, it remains private to your project. Gemini Enterprise Agent Platform ensures its security by preventing other users from accessing your models and endpoints.
...
The following function uploads the model to Gemini Enterprise Agent Platform, configures deployment settings, and deploys it to an endpoint using vLLM.
...
After running this code sample, your Llama 3.1 model will be deployed on Gemini Enterprise Agent Platform and accessible through the specified endpoint. You can interact with it for inference tasks such as text generation, summarization, and dialogue. Depending on model size, new model deployment can take up to an hour. You can check the progress at online prediction.
...
After successfully deploying the Llama 3.1 model to Gemini Enterprise Agent Platform, you can start making predictions by sending text prompts to the endpoint. This section provides an example of generating responses with various customizable parameters for controlling the output.
...
Now that the instance is configured, you can send the prediction request to the deployed Gemini Enterprise Agent Platform endpoint. This example shows how to make a prediction and print the result:
...
This section walks you through the process of uploading prebuilt Llama 3.2 models to the Model Registry and deploying them to a Gemini Enterprise Agent Platform endpoint. The deployment time can take up to an hour, depending on the size of the model. Llama 3.2 models are available in multimodal versions that support both text and image inputs. vLLM supports:
...
The following function handles the deployment of the Llama 3.2 model on Gemini Enterprise Agent Platform. It configures the model's environment, memory utilization, and vLLM settings for efficient serving.
...
Depending on model size, new model deployment can take up to an hour to complete. You can check its progress at online prediction.

## Inference with vLLM on Gemini Enterprise Agent Platform using default prediction route

This section guides you through setting up inference for the Llama 3.2 Vision model on Gemini Enterprise Agent Platform using the default prediction route. You'll use the vLLM library for efficient serving and interact with the model by sending a visual prompt in combination with text.
...
This section covers how to perform inference on Llama 3.2 Vision models using the OpenAI Chat Completions API on Gemini Enterprise Agent Platform. This approach lets you use multimodal capabilities by sending both images and text prompts to the model for more interactive responses.
...
Begin by setting up the endpoint resource name for your Gemini Enterprise Agent Platform deployment.
...
Using OpenAI's Chat Completions API, send the image and text prompt to your Gemini Enterprise Agent Platform endpoint:
...
This section provides guidance on identifying and resolving common issues encountered during vLLM model deployment and inference on Gemini Enterprise Agent Platform.
...
![Error message indicating that the Llama 3.2 deployment failed](https://docs.cloud.google.com/static/gemini-enterprise-agent-platform/models/open-models/vllm/images/llama3_2_failed_deployment.png) **Figure 8: Failed Llama 3.2 Deployment**
...
<tr class="header">
<th><br />
<strong>Release date</strong></th>
<th><br />
<strong>Architecture</strong></th>
<th><br />
<strong><a href="https://github.com/vllm-project/vllm/releases">vLLM version</a></strong></th>
<th><br />
<strong>Container URI</strong></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
v0.9.2</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250717_0916_arm_RC01</td>
</tr>
<tr class="even">
<td>Jul 10, 2025</td>
<td><br />
...
v0.9.2</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250710_0916_RC01</td>
</tr>
<tr class="odd">
<td>Jun 20, 2025</td>
<td><br />
x86</td>
<td><br />
Past v0.9.1, <a href="https://github.com/vllm-project/vllm/commit/5e666f72cdb1aa7dade649d92a45e93983937fd2">commit</a></td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250620_0916_RC01</td>
</tr>
<tr class="even">
<td>Jun 11, 2025</td>
<td><br />
...
v0.9.1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250611_0916_RC01</td>
</tr>
<tr class="odd">
<td>Jun 2, 2025</td>
<td><br />
...
v0.9.0</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250601_0916_RC01</td>
</tr>
<tr class="even">
<td>May 6, 2025</td>
<td><br />
...
v0.8.5.post1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250506_0916_RC01</td>
</tr>
<tr class="odd">
<td>Apr 29, 2025</td>
<td><br />
...
v0.8.4</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250429_0916_RC01, 20250430_0916_RC00_maas</td>
</tr>
<tr class="even">
<td>Apr 17, 2025</td>
<td><br />
...
v0.8.4</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250417_0916_RC01</td>
</tr>
<tr class="odd">
<td>Apr 10, 2025</td>
<td><br />
x86</td>
<td><br />
Past v0.8.3, <a href="https://github.com/vllm-project/vllm/commit/098900d7c2b53324687977eece400f634755cf51">commit</a></td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250410_0917_RC01</td>
</tr>
<tr class="even">
<td>Apr 7, 2025</td>
<td><br />
...
v0.8.3</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250407_0917_RC01, 20250407_0917_RC0120250429_0916_RC00_maas</td>
</tr>
<tr class="odd">
<td>Apr 7, 2025</td>
<td><br />
...
v0.8.1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250404_0916_RC01</td>
</tr>
<tr class="even">
<td>Apr 5, 2025</td>
<td><br />
x86</td>
<td><br />
Past v0.8.2, <a href="https://github.com/vllm-project/vllm/commit/55acf86bf817cca4baf9ed7a3f6e23be510d0198">commit</a></td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250405_1205_RC01</td>
</tr>
<tr class="odd">
<td>Mar 31, 2025</td>
<td><br />
...
v0.8.1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250401_0916_RC01</td>
</tr>
<tr class="even">
<td>Mar 26, 2025</td>
<td><br />
...
v0.8.1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250327_0916_RC01</td>
</tr>
<tr class="odd">
<td>Mar 23, 2025</td>
<td><br />
...
v0.8.1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250324_0916_RC01</td>
</tr>
<tr class="even">
<td>Mar 21, 2025</td>
<td><br />
...
v0.8.1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250321_0916_RC01</td>
</tr>
<tr class="odd">
<td>Mar 11, 2025</td>
<td><br />
x86</td>
<td><br />
Past v0.7.3, <a href="https://github.com/vllm-project/vllm/commit/f6bb18fd9a19e5e4fb1991339638fc666d06b27a">commit</a></td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250312_0916_RC01</td>
</tr>
<tr class="even">
<td>Mar 3, 2025</td>
<td><br />
...
v0.7.2</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250304_0916_RC01</td>
</tr>
<tr class="odd">
<td>Jan 14, 2025</td>
<td><br />
...
v0.6.4.post1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20250114_0916_RC00_maas</td>
</tr>
<tr class="even">
<td>Dec 2, 2024</td>
<td><br />
...
v0.6.4.post1</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20241202_0916_RC00_maas</td>
</tr>
<tr class="odd">
<td>Nov 12, 2024</td>
<td><br />
...
v0.6.2</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20241112_0916_RC00_maas</td>
</tr>
<tr class="even">
<td>Oct 16, 2024</td>
<td><br />
...
v0.6.2</td>
<td><br />
us-docker.pkg.dev/vertex-ai/vertex-vision-model-garden-dockers/pytorch-vllm-serve:20241016_0916_RC00_maas</td>
</tr>
</tbody>
</table>
...
x86</td>
<td><br />
us-docker.pkg.dev/vertex-ai-restricted/vertex-vision-model-garden-dockers/pytorch-vllm-optimized-serve:20250121_0835_RC00</td>
</tr>
<tr class="even">
<td>Oct 29, 2024</td>
<td><br />
x86</td>
<td><br />
us-docker.pkg.dev/vertex-ai-restricted/vertex-vision-model-garden-dockers/pytorch-vllm-optimized-serve:20241029_0835_RC00</td>
</tr>
</tbody>
</table>
