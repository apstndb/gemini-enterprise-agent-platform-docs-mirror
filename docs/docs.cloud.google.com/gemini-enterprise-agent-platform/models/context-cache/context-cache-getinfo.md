---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/context-cache/context-cache-getinfo
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/context-cache/context-cache-getinfo
title: Get information about a context cache
description: Learn how to get information about a context cache in Gemini Enterprise Agent Platform, including creation time, update time, expiration time, and cache IDs.
