---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/3-8-flash
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/gemini/3-8-flash
title: Gemini 3.8 Flash
description: Learn about Gemini 3.8 Flash, our model optimized for multi-step orchestration, full-stack code refactoring, and general reasoning.
...
> **Note:** `thinking_level="MINIMAL"` is not available for 3.8 Flash. Explicitly setting `thinking_level` to `MINIMAL` will return an API validation error. The supported values for 3.8 Flash are `LOW` , `MEDIUM` (default), and `HIGH` .

[Try in Agent Studio](https://console.cloud.google.com/agent-platform/studio/chat?model=gemini-3.8-flash) [Deploy example app](https://console.cloud.google.com/agent-platform/studio/chat?suggestedPrompt=How%20does%20AI%20work&deploy=true&model=gemini-3.8-flash) [Developer guide](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/guides/gemini-3-8-flash) [Pricing](https://cloud.google.com/gemini-enterprise-agent-platform/generative-ai/pricing)
