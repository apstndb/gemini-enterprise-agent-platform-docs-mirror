---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-resume
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-resume
...
## What's next
  ...
  - Learn more about [Batch inference from Cloud Storage](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-from-cloud-storage) .
  - Learn more about [Batch inference for BigQuery](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/batch-prediction-from-bigquery) .
