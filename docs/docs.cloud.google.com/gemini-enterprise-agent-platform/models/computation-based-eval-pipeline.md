---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/computation-based-eval-pipeline
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/computation-based-eval-pipeline
title: Run a computation-based evaluation pipeline
description: Gemini Enterprise Agent Platform is a central console designed for platform and security administrators to build, scale, monitor, optimize, and govern the entire lifecycle of AI agents.
data_source: docs.cloud.google.com
---

> **Note:** For the most updated computation-based evaluation features, see [Define your metrics](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/determine-eval#computation-based-metrics) .
...
You can either [create a new Cloud Storage bucket](https://docs.cloud.google.com/storage/docs/creating-buckets#create_a_new_bucket) or use an existing one to store your dataset file. The bucket must be in the same region as the model.

After your bucket is ready, [upload](https://docs.cloud.google.com/storage/docs/creating-buckets#create_a_new_bucket) your dataset file to the bucket.
