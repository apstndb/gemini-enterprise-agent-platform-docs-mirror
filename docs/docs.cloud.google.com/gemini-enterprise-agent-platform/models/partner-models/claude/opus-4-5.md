...
title: Claude Opus 4.5 on Google Cloud
description: Claude Opus 4.5 on Google Cloud is optimized for coding, agents, computer use, and enterprise workflows.
...
`claude-opus-4-5`
  ...
  - **Retirement date not sooner than:** November 24, 2026
