---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/models/partner-models/claude/fable-5-1
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/partner-models/claude/fable-5-1
title: Claude Fable 5.1 on Google Cloud
description: Claude Fable 5.1 on Google Cloud is optimized for autonomous knowledge work and coding, handling long-running, complex, and asynchronous tasks.
...
**Retirement date:** No sooner than March 1, 2027.

[Try in Agent Studio](https://console.cloud.google.com/agent-platform/publishers/anthropic/model-garden/claude-fable-5-1) [View model card in Model Garden](https://console.cloud.google.com/agent-platform/publishers/anthropic/model-garden/claude-fable-5-1)
...
## Enable Claude Fable 5.1 on Google Cloud in your project

Follow these steps to enable Claude Fable 5.1 on Google Cloud in your project:
