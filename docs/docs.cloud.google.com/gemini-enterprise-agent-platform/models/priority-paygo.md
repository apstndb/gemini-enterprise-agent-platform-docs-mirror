...
Before using any of the request data, make the following replacements:
  ...
  - `  MODEL_ID  ` : The model ID of the model for which you want to initialize Priority PayGo. For a list of models that support Priority PayGo, see [Model versions](https://docs.cloud.google.com/gemini-enterprise-agent-platform/priority-paygo#supported-models) .
