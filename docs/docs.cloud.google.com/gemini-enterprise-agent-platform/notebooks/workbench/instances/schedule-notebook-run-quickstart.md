...
description: Shows how to schedule a notebook run in a Vertex AI Workbench instance
...
To get the permissions that you need to create a Vertex AI Workbench instance and open JupyterLab, ask your administrator to grant you the following IAM roles on the project:
...
To ensure that your instance's service account has the necessary permissions to interact with the Vertex AI Workbench executor, ask your administrator to grant the following IAM roles to your instance's service account on the project:
