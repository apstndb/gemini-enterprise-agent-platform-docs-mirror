...
Backward compatibility with your Agent Platform Workbench isn't guaranteed. [Make a copy of your data](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/general/troubleshooting-workbench#copy-user-data) before upgrading a Agent Platform Workbench instance.
