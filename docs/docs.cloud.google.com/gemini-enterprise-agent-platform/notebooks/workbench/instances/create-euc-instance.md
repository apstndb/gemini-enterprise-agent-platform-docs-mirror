...
title: Create a Vertex AI Workbench instance with user credential access
...
9.  Users must grant consent to the OAuth client to manage their credentials for each Vertex AI Workbench instance. This is done one time per instance. To grant consent, click **Open JupyterLab** and complete the dialog that appears.
