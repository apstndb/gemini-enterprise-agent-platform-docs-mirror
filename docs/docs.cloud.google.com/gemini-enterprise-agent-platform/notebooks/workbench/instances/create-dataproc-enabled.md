...
description: Learn how to create a Managed Service for Apache Spark Spark-enabled Agent Platform Workbench instance
...
To diagnose and resolve issues related to creating a Managed Service for Apache Spark Spark-enabled instance, see [Troubleshooting Agent Platform Workbench](https://docs.cloud.google.com/vertex-ai/docs/general/troubleshooting-workbench#dataproc-instances) .
