...
Google provides [client libraries](https://docs.cloud.google.com/vertex-ai/docs/workbench/reference/libraries) for many popular languages to access this API. If your desired programming language is supported by the client libraries, you should use this option.
...
This API supports [REST](https://en.wikipedia.org/wiki/Representational_state_transfer) . See the [REST reference](https://docs.cloud.google.com/vertex-ai/docs/workbench/reference/rest) for this API. Also see [How to call Google APIs: REST edition](https://googleapis.github.io/HowToREST) .
