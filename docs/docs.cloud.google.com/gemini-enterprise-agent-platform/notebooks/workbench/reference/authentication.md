---
name: documents/docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication
uri: https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication
title: Authenticate to Agent Platform Workbench
description: Learn how to authenticate to Gemini Enterprise Agent Platform Workbench.
data_source: docs.cloud.google.com
---

This document describes how to authenticate to Gemini Enterprise Agent Platform Workbench programmatically. How you authenticate to Gemini Enterprise Agent Platform Workbench depends on the interface you use to access the API and the environment where your code is running.
...
Agent Platform Workbench supports programmatic access. You can access the API in the following ways:

  - [Client libraries](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication#client-libraries)
  - [Google Cloud CLI](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication#gcloud)
  - [REST](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication#rest)

### Client libraries

The [Agent Platform Workbench client libraries](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/libraries) provide high-level language support for authenticating to Agent Platform Workbench programmatically. To authenticate calls to Google Cloud APIs, client libraries support [Application Default Credentials (ADC)](https://docs.cloud.google.com/docs/authentication/application-default-credentials) ; the libraries look for credentials in a set of defined locations and use those credentials to authenticate requests to the API. With ADC, you can make credentials available to your application in a variety of environments, such as local development or production, without needing to modify your application code.

### Google Cloud CLI

When you use the [gcloud CLI](https://docs.cloud.google.com/sdk/gcloud/reference/workbench) to access Agent Platform Workbench, you authenticate to Google Cloud as a principal, which provides the credentials used by the gcloud CLI commands.

If your organization's security policies prevent user accounts from having the required permissions, you can use [service account impersonation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication#sa-impersonation) .

For more information, see [Authenticate for the gcloud CLI](https://docs.cloud.google.com/sdk/docs/authenticate) . For more information about using the gcloud CLI with Agent Platform Workbench, see [the gcloud CLI reference pages](https://docs.cloud.google.com/sdk/gcloud/reference/workbench) .

### REST

You can authenticate to [the Notebooks API](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/rest) by using your [gcloud CLI credentials](https://docs.cloud.google.com/sdk/docs/authenticate) or by using [Application Default Credentials](https://docs.cloud.google.com/docs/authentication/application-default-credentials) . For more information about authentication for REST requests, see [Authenticate for using REST](https://docs.cloud.google.com/docs/authentication/rest) .
...
You can set up credentials for a local development environment in the following ways:
  ...
  - [User credentials for client libraries or third-party tools](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication#client-libs)
  - [User credentials for REST requests from the command line](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication#rest-requests)
  - [Service account impersonation](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/authentication#sa-impersonation)
...
## Access control for Agent Platform Workbench

After you authenticate to Agent Platform Workbench, you must be authorized to access Google Cloud resources. Agent Platform Workbench uses Identity and Access Management (IAM) for authorization.

For more information about the roles for Agent Platform Workbench, see [Access control](https://docs.cloud.google.com/gemini-enterprise-agent-platform/notebooks/workbench/reference/gemini-enterprise-agent-platform/notebooks/workbench/instances/iam) . For more information about IAM and authorization, see [IAM overview](https://docs.cloud.google.com/iam/docs/overview) .
